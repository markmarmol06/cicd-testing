...
- Name: playwright-typescript/tests/checkout.spec.ts >> Checkout >> complete checkout flow end-to-end
- Location: playwright-typescript/tests/checkout.spec.ts:16:7
